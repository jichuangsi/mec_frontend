<template>
    <div>
        <el-card >
            <el-row>
                <el-col :span="1"><div @click="cancel" class="top"><i class="el-icon-back" style="font-size:20px;"></i><span style="margin-left:5px;">返回</span></div> </el-col>
        ...
        <el-card style="margin-top:20px;">
            ...
            <el-form ref="tProduct" :model="tProduct" label-width="80px" style="width:600px;padding-left:80px;">
                ...
                <el-form-item label="线轴">
                    ...
                    <el-option :label="item.name" :value="item.id" v-for="item in selecteds.XZ" :key="item.id"></el-option>
                    </el-select>
                </el-form-item>
             ...
             <el-table
                ...
                >
                    <template slot-scope="scope">
                        {{scope.row.umStart+'-'+scope.row.umEnd}}
                    </template>
                </el-table-column>
                <el-table-column
                label="成品直径mil">
                    <template slot-scope="scope">
                        {{scope.row.milStart+'-'+scope.row.milEnd}}
                    </template>
                </el-table-column>
                <el-table-column
                label="延伸率EL%">
                    <template slot-scope="scope">
                        {{scope.row.elStart+'-'+scope.row.elEnd}}
                    </template>
                </el-table-column>
                <el-table-column
                label="拉断力BL(CN)">
                    <template slot-scope="scope">
                        {{scope.row.blStart+'-'+scope.row.blEend}}
                    </template>
                </el-table-column>
                <el-table-column
                label="粗拉直径um">
                    <template slot-scope="scope">
                        {{scope.row.coarseStart+'-'+scope.row.coarseEnd}}
                    </template>
                </el-table-column>
                <el-table-column
                label="中拉直径um">
                    <template slot-scope="scope">
                        {{scope.row.diamStart+'-'+scope.row.diamEnd}}
                    </template>
                </el-table-column>
                <el-table-column
                label="半成品直径um">
                    <template slot-scope="scope">
                        {{scope.row.semiStart+'-'+scope.row.semiEnd}}
                    </template>
                </el-table-column>
                <el-table-column
                label="操作">
                ...
                <el-form ref="tProstandardsItem" :model="tProstandardsItem" label-width="120px" >
                    ...
                    <el-row>
                        <el-col :span="12">
                            ...
                            <el-col :span="12">
                                <el-input v-model="tProstandardsItem.umStart" type="number"></el-input>
                            </el-col>
                        ...
                        <el-col :span="12">
                            ...
                            <el-col :span="24">
                                <el-input disabled="" type="number" v-model="tProstandardsItemMil" style="width:38%"></el-input>
                                注:1mil=25.4um
                            </el-col>
        ...
        <!-- 新增原料配比的对话框 -->
        <el-dialog
            :title="rawMaterialRatiosItemIndex==-1?'新增':'编辑'"
            @close='addMaterialClose'
        ...
        <el-dialog
            title="编辑"
            :visible.sync="gxLossBislistVisible"
            width="40%"
            @close="gxLossBislistClose()"
            >
...
export default {
    ...
    computed: {
        tProstandardsItemMil () {
            return (parseFloat(this.tProstandardsItem.umStart)/25.4).toFixed(2)
        },
    },
    methods:{
        // 编辑页面根据id获取初始数据
