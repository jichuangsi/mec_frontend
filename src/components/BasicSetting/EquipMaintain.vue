  ...
  <div>
    ...
    <el-card style="margin-top:20px;">
      <div style="font-weight:bold;">
        ...
        <el-button type="warning" plain @click="outService" v-show="state==0">设备停用</el-button>
        <el-button type="success" plain @click="outService" v-show="state==1">设备启用</el-button>
          ...
          <template slot-scope="scope">
            <div v-if="scope.row.shiftShow" class="line-wrapper">
              <p
                style="height:25px"
                v-if="
                  scope.row.mechanism[index].value === 'B1' ||
                    scope.row.mechanism[index].value === 'BY1,1' ||
                    scope.row.mechanism[index].value === 'BY1,2' ||
                    scope.row.mechanism[index].value === 'BY1,3' ||
                    scope.row.mechanism[index].value === 'BY1,4'
                "
              >
                ✔
              </p>
              <p
                style="height:25px;font-size:20px;margin-bottom:20px;"
                v-else-if="
                  scope.row.mechanism[index].value === 'B2' ||
                    scope.row.mechanism[index].value === 'BY2,1' ||
                    scope.row.mechanism[index].value === 'BY2,2' ||
                    scope.row.mechanism[index].value === 'BY2,3' ||
                    scope.row.mechanism[index].value === 'BY2,4'
                "
              >
                ×
              </p>
              <p
                style="height:25px"
                v-else-if="
                  scope.row.mechanism[index].value === 'B3' ||
                    scope.row.mechanism[index].value === 'BY3,1' ||
                    scope.row.mechanism[index].value === 'BY3,2' ||
                    scope.row.mechanism[index].value === 'BY3,3' ||
                    scope.row.mechanism[index].value === 'BY3,4'
                "
              >
                ▢
              </p>
              <p
                style="height:25px"
                v-else-if="
                  scope.row.mechanism[index].value === 'B4' ||
                    scope.row.mechanism[index].value === 'BY4,1' ||
                    scope.row.mechanism[index].value === 'BY4,2' ||
                    scope.row.mechanism[index].value === 'BY4,3' ||
                    scope.row.mechanism[index].value === 'BY4,4'
                "
              >
                ⚪
              </p>
              ...
              <p
                style="height:25px"
                v-if="
                  scope.row.mechanism[index].value === 'Y1' ||
                    scope.row.mechanism[index].value === 'BY1,1' ||
                    scope.row.mechanism[index].value === 'BY2,1' ||
                    scope.row.mechanism[index].value === 'BY3,1' ||
                    scope.row.mechanism[index].value === 'BY4,1'
              ...
              <p
                style="height:25px"
                v-else-if="
                  scope.row.mechanism[index].value === 'Y2' ||
                    scope.row.mechanism[index].value === 'BY1,2' ||
                    scope.row.mechanism[index].value === 'BY2,2' ||
                    scope.row.mechanism[index].value === 'BY3,2' ||
                    scope.row.mechanism[index].value === 'BY4,2'
              ...
              <p
                style="height:25px"
                v-else-if="
                  scope.row.mechanism[index].value === 'Y3' ||
                    scope.row.mechanism[index].value === 'BY1,3' ||
                    scope.row.mechanism[index].value === 'BY2,3' ||
                    scope.row.mechanism[index].value === 'BY3,3' ||
                    scope.row.mechanism[index].value === 'BY4,3'
              ...
              <p
                style="height:25px"
                v-else-if="
                  scope.row.mechanism[index].value === 'Y4' ||
                    scope.row.mechanism[index].value === 'BY1,4' ||
                    scope.row.mechanism[index].value === 'BY2,4' ||
                    scope.row.mechanism[index].value === 'BY3,4' ||
                    scope.row.mechanism[index].value === 'BY4,4'
      ...
      <el-dialog title="检修" :visible.sync="dialogVisible" width="40%" @close="dialogClose">
        ...
        <el-table :data="equipmentItemsList" border :span-method="objectSpanMethod" style="width:541px;">
    ...
    <div></div>
    <el-dialog title="新增年月" :visible.sync="yearDialogVisible" width="30%" @close="yearDialogClose">
  ...
  methods: {
    ...
    async outService() {
      if (this.state == 0) {
        ...
        const confirmResult = await this.$confirm('是否确认启用？', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).catch(err => err)
