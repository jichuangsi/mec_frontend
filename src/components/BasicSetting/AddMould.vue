<template>
  <div>
    <el-page-header @back="cancel" content="新增成套模具"> </el-page-header>
    ...
    <el-card style="margin-top:20px">
      ...
      <el-table :data="cuffingcheck" style="width: 100%"  :header-cell-style="{background:'#f0f5ff' }">
        ...
        <el-table-column prop="sonmouldModel" label="子模编号"> </el-table-column>
        <el-table-column prop="sonmouldSpaNum" label="子模具孔径(μm)"> </el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" @click="showDialog(scope.$index)">编辑</el-button>
...
export default {
  ...
  methods: {
    ...
    dialogConfirm() {
      ...
      if(this.index>=0){
          this.cuffingcheck.splice(this.index,1,{ ...this.cuffingcheckItem })
      }else{
