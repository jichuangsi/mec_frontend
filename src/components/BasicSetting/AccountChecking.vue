            ...
            <el-table :header-cell-style="{ background: '#f0f5ff' }" :data="tableData" style="width: 100%" :default-sort="{ prop: 'date', order: 'descending' }">
              ...
              <el-table-column label="启用状态">
                <template slot-scope="scope">
                  <el-switch v-model="scope.row.scrapNo" :active-value="0" :inactive-value="1" @change="switchChange(scope.row.id)"> </el-switch>
                </template>
              </el-table-column>
        ...
        <template>
          <el-form label-width="80px">
            ...
            <el-table :header-cell-style="{ background: '#f0f5ff' }" :data="tableData1" style="width: 100%" :default-sort="{ prop: 'date', order: 'descending' }">
              ...
              <el-table-column label="启用状态">
                <template slot-scope="scope">
                  <el-switch v-model="scope.row.stateNo" :active-value="0" :inactive-value="1" @change="switchChange(scope.row.id)"> </el-switch>
                </template>
              </el-table-column>
              <el-table-column label="操作" width="240">
                <template slot-scope="scope">
