      ...
      >
        <el-col :span="24">
          ...
          >
              ...
              >首页</el-menu-item>  
            <el-submenu index="2">
              <template slot="title">客户关系</template>
              <el-menu-item
                index="/supplier"
                @click="saveNavState('/supplier')"
              >供应商管理</el-menu-item>
              <el-menu-item
                index="/client"
                @click="saveNavState('/client')"
              >客户管理</el-menu-item>
              <el-menu-item
                index="/complaint"
                @click="saveNavState('/complaint')"
              >客户投诉管理</el-menu-item>
            </el-submenu>
            <el-submenu index="3">
              ...
              <el-menu-item
                index="/purchaseorder"
                @click="saveNavState('/purchaseorder')"
              >采购订单管理</el-menu-item>
              <el-menu-item
                index="/orderreview"
                @click="saveNavState('/orderreview')"
              >订单审核</el-menu-item>
              <el-menu-item
                index="/incominginspection"
                @click="saveNavState('/incominginspection')"
              >来料检验</el-menu-item>
              <el-menu-item
                index="/warehousing"
            ...
            <el-submenu index="4">
              ...
              <el-menu-item
                index="/saleorder"
                @click="saveNavState('/saleorder')"
              >销售订单管理</el-menu-item>
              <el-menu-item
                index="/saleOrderReview"
                @click="saveNavState('/saleOrderReview')"
              >订单审核</el-menu-item>
              <el-menu-item
                index="/saleOut"
                @click="saveNavState('/saleOut')"
              >销售出库</el-menu-item>
              <el-menu-item
                index="/saleOrderBack"
                @click="saveNavState('/saleOrderBack')"
              >销售退回</el-menu-item>
              <el-menu-item
                index="/accountStatement"
                @click="saveNavState('/accountStatement')"
              >对账单</el-menu-item>
