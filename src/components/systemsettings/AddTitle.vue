<template>
  <el-card>
    ...
    <el-form :label-position="labelPosition" label-width="80px" :model="addTitleForm">
      ...
      <el-form-item label="职称简介">
        <el-input v-model="addTitleForm.remark" placeholder="请输入内容"></el-input>
        <div class="tips">*职称级别按数字由小到大排序，数字越大级别越高</div>
      </el-form-item>
      <el-form-item label="职称状态">
        <el-switch v-model="addTitleForm.postState" :active-value="0" :inactive-value="1"> </el-switch>
      </el-form-item>
