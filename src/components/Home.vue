<template>
  <el-container class="home-container">
    ...
    <el-container>
      ...
      <el-aside
        width=" 200px"
        style="backgroundColor:#333744;overflow-x:hidden"
      >
        <el-col :span="24">
          ...
          >
            <el-submenu index="1">
              ...
              <el-menu-item
                index="/homepage"
                @click="saveNavState('/homepage')"
              >主页</el-menu-item>
              <el-menu-item
                index="/workbench"
                @click="saveNavState('/workbench')"
              >工作台</el-menu-item>
            </el-submenu>
            <el-submenu index="2">
              <template slot="title">代办事项</template>
              <el-menu-item
                index="/todo"
                @click="saveNavState('/todo')"
              >代办事项</el-menu-item>
              <el-menu-item
                index="/doing"
                @click="saveNavState('/doing')"
              >进行事项</el-menu-item>
              <el-menu-item
                index="/done"
                @click="saveNavState('/done')"
              >完成事项</el-menu-item>
            </el-submenu>
            <el-submenu index="3">
              <template slot="title">生产计划</template>
              <el-menu-item
                index="/production"
                @click="saveNavState('/production')"
              >创建生产计划单</el-menu-item>
              <el-menu-item
                index="/examine"
                @click="saveNavState('/examine')"
              >生产计划单审核</el-menu-item>
            </el-submenu>
            <el-submenu index="4">
              <template slot="title">生产管理</template>
              <el-menu-item
                index="/melting"
                @click="saveNavState('/melting')"
              >熔炼</el-menu-item>
              <el-menu-item
                index="/roughDrawing"
                @click="saveNavState('/roughDrawing')"
              >粗拉</el-menu-item>
              <el-menu-item
                index="/mediumPull"
                @click="saveNavState('/mediumPull')"
              >中拉</el-menu-item>
              <el-menu-item
                index="/thinPull"
                @click="saveNavState('/thinPull')"
              >半成品(细拉)</el-menu-item>
              <el-menu-item
                index="/superThinPull"
              ...
              <el-menu-item
                index="/elTest"
                @click="saveNavState('/elTest')"
              >EL/BL测试</el-menu-item>
              <el-menu-item
                index="/winding"
                @click="saveNavState('/winding')"
              >绕线</el-menu-item>
              <el-menu-item
                index="/detour"
                @click="saveNavState('/detour')"
              >成品改绕</el-menu-item>
            </el-submenu>
            <el-submenu index="5">
              <template slot="title">质量检验</template>
            ...
            <el-submenu index="7">
              ...
              <el-menu-item
                index="/modelSetting"
                @click="saveNavState('/modelSetting')"
              >规格型号设置</el-menu-item>
              <el-menu-item
                index="/maintainManage"
                @click="saveNavState('/maintainManage')"
              >仪器设备管理维护</el-menu-item>
              <el-menu-item
                index="/accountChecking"
                @click="saveNavState('/accountChecking')"
              >模具管理核账</el-menu-item>
              <el-menu-item
                index="/printer"
                @click="saveNavState('/accountChecking')"
