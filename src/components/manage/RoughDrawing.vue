<template>
  <el-card>
    <el-row :gutter="20">
      ...
      <el-col :span="2"><div class="item current">粗拉</div></el-col>
      ...
      <el-table :header-cell-style="{ background: '#f0f5ff' }" :data="tableData" style="width: 100%;margin-top:0">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" @click="toAddRough(scope.row.id)">查看</el-button>
...
export default {
  ...
  methods: {
    toFeeding(){
      this.$router.push("/roughDrawingFeeding")
    },
    // 删除单行数据
    async del(id) {
