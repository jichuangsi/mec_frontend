<template>
  <div>
    <el-page-header @back="goback" content="新增采购入库" style="margin-bottom:20px;"> </el-page-header>
    ...
    <el-card style="margin-top:20px;">
      <el-row>
        ...
        <el-col :span="8" :offset="12" v-if="tPurchase.orderState == 6">
      ...
      <el-table :header-cell-style="{ background: '#f0f5ff' }" :data="tableData" style="width: 100%">
        ...
        <el-table-column label="操作" v-if="tPurchase.orderState == 6">
...
export default {
  ...
  methods: {
    ...
    async withdrawConfirm() {
      ...
      const { data: res } = await this.$http.post('PurchaseController/updateMaterialEnter', this.withdrawForm)
    ...
    addDialogConfirm() {
      ...
      this.tableData.push(this.tableFormItem)
