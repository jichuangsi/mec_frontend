<template>
  <div>
    <el-page-header @back="goback" content="采购订单审核" style="margin-bottom:20px;"> </el-page-header>
    <!-- 申请采购单 -->
    ...
    <el-card style="margin-top:20px;">
      ...
      <el-table :header-cell-style="{ background: '#f0f5ff' }" :data="purchaseDetail" style="width: 100%;margin-bottom:20px;">
    ...
    <el-card style="margin-top:20px;">
      ...
      <div class="footer" v-if="purchase.orderState == 1 || purchase.orderState == 2">
        <el-button type="primary" @click="showDialog('T')">审核通过</el-button>
        <el-button type="warning" @click="showDialog('F')">驳回</el-button>
      </div>
    </el-card>
    <el-dialog :title="type == 'T' ? '审核通过' : '驳回'" :visible.sync="dialogVisible" width="30%" @close="dialogClose">
