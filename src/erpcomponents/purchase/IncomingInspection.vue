    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="来料检验" name="first">
        <template>
          ...
          <el-pagination :current-page="subForm.pageNum" :page-sizes="[5, 10, 15, 20]" :page-size="subForm.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total"> </el-pagination>
        </template>
      </el-tab-pane>
