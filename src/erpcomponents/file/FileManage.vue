    ...
    <el-card>
        ...
        <el-form   label-width="120px">
            ...
            style="width: 100%;margin-top:0">
                ...
                <el-table-column
                    prop="isEncryptionstr"
                    label="是否加密">                    
                </el-table-column>
                <el-table-column                  
                    label="操作">
                    <template slot-scope="scope">                     
                            <el-button type="primary"  size="mini" @click="showPasswordDialog(scope.row.id,'download')">下载</el-button>                            
                            <el-button type="success"  size="mini" @click="showPasswordDialog(scope.row.id,'update')">更新</el-button>                            
        ...
        <el-form ref="form" :model="form" label-width="80px">
            <el-form-item label="文件上传">
                <el-upload
                    ...
                    action="http://192.168.31.96:8080/fileController/upload"
        ...
        <el-row >
            ...
            <el-col :span="12" :offset="1"><el-input placeholder="请输入密码" v-model="dialogPassword"></el-input></el-col>
        </el-row>
        <span slot="footer" class="dialog-footer">
...
export default {
    ...
    methods: {
        ...
        async dialogConfirm(){
            ...
            this.addForm.filePassword=this.form.password2
        ...
        async addDialog(id=-1){
            if(id>=0){
                ...
                this.fileList.push({
                    ...
                    url:'http://192.168.31.96:8080/'+res.data.fileTable.fileRoute
                })
            }
        ...
        async downLoad(id){
            ...
            if (res.code !== "0010") return this.$message.error(res.msg)
            window.location.href = 'http://192.168.31.96:8080/'+res.data;
        },
        // 获取页面初始数据
        async getData(){
