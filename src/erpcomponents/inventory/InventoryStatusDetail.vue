<template>
    <div>
        <el-page-header @back="cancel" content="库存详情" style="margin-bottom:20px;">
        </el-page-header>
        <el-row :gutter="20">
            <el-col :span="12">
                <el-card >
                    ...
                    <el-row style="margin:40px 0;">
                        <el-col :span="12">
                            ...
                            <el-col :span="12">{{stockDetail.stockNumber}}</el-col>
                        </el-col>
                         <el-col :span="12">
                            <el-col :span="12">原材料线别</el-col>
                            <el-col :span="12">{{stockDetail.stockType}}</el-col>
                        </el-col>
                    </el-row>
                    <el-row style="margin:40px 0;">
                        <el-col :span="12">
                            <el-col :span="12">原材料名称</el-col>
                            <el-col :span="12">{{stockDetail.stockName}}</el-col>
                        </el-col>
                         <el-col :span="12">
                            <el-col :span="12">原材料说明</el-col>
                            <el-col :span="12">{{stockDetail.stockRemarks}}</el-col>
                        </el-col>
                    </el-row>
                    <el-row style="margin:40px 0;">
                        <el-col :span="12">
                            <el-col :span="12">原材料型号</el-col>
                            <el-col :span="12">{{stockDetail.stockModel}}</el-col>
                        </el-col>
                         <el-col :span="12">
                            <el-col :span="12">单位</el-col>
                            <el-col :span="12">{{stockDetail.dictionarier}}</el-col>
                        </el-col>
                    </el-row>
                </el-card>
            </el-col>
