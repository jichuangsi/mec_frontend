<template>
  <el-card>
    <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <template>
          <el-form ref="form" label-width="80px">
            ...
            <el-table :header-cell-style="{ background: '#f0f5ff' }" :data="firstTableData" style="width: 100%">
              ...
              <el-table-column prop="staffName" label="当前审批人"> </el-table-column>
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <el-button type="primary" size="mini" @click="toDetail(scope.row.id)" :disabled="rolePowerList.indexOf(77)==-1">查看</el-button>
                </template>
              </el-table-column>
            </el-table>
          </el-form>
      ...
      <el-tab-pane label="审核设置" name="TH">
        <template>
          <el-form ref="form" label-width="80px">
            <el-row :gutter="40">
              <el-col :span="12">
...
export default {
  ...
  created() {
    ...
    if (sessionStorage.getItem('saleorderback')) {
      this.activeName = sessionStorage.getItem('saleorderback')
    }
    this.getData()
  },
  methods: {
    ...
    handleClick() {
      this.getData()
      sessionStorage.setItem('saleorderback', this.activeName)
    },
    toDetail(id) {
      this.$router.push({
