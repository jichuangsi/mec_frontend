  ...
  <el-card>
    <el-form ref="form" label-width="120px">
      ...
      <el-table :header-cell-style="{ background: '#f0f5ff' }" :data="tableData" style="width: 100%;margin-top:0">
        ...
        <el-table-column prop="customerName" label="投诉客户"> </el-table-column>
        <el-table-column prop="complaintTitle" label="投诉标题"> </el-table-column>
    ...
    <el-dialog title="新增" :visible.sync="dialogVisible" width="40%">
      <el-form ref="addForm" :model="addForm" label-width="80px" style="width:80%;">
        <el-form-item label="投诉客户">
          <el-select v-model="addForm.customerId" placeholder="请选择" style="width:100%;">
        ...
        <el-form-item label="投诉内容">
          <el-input type="textarea" :rows="4" placeholder="请输入内容" v-model="addForm.complaintContent"> </el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="编辑" :visible.sync="editDialogVisible" width="40%">
      <el-form ref="editForm" :model="editForm" label-width="80px" style="width:80%;">
        ...
        <el-form-item label="投诉内容">
          <el-input type="textarea" :rows="4" placeholder="请输入内容" v-model="editForm.complaintContent"> </el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
